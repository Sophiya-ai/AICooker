...
async def cmd_start(message: Message) -> None:
    ...
    await message.answer(
        (
            ...
            "По умолчанию анализ выполняется бесплатно и локально. "
            "Команда /provider позволяет выбрать локальный AI или GPT через OpenAI API.\n\n"
            "Примеры:\n"
...
async def cmd_help(message: Message) -> None:
    ...
    await message.answer(
        (
            ...
            "6. /provider — выбери бесплатный локальный AI или GPT.\n\n"
